...
describe('InviteMembersModal', function() {
  ...
  it('indicates the total invites on the invite button', function() {
    ...
    expect(wrapper.find('Button[label="send invites"]').text()).toBe('Send invites (2)');
  });
  ...
  it('can be closed', function() {
    ...
    wrapper.find('Button[label="cancel"]').simulate('click');
  ...
  it('sends all successful invites', async function() {
    ...
    expect(wrapper.find('Button[label="cancel"][disabled]').exists()).toBe(true);
    expect(wrapper.find('Button[label="send invites"][disabled]').exists()).toBe(true);
    ...
    expect(wrapper.find('Button[label="done"]').exists()).toBe(true);
    expect(wrapper.find('Button[label="send more"]').exists()).toBe(true);
    expect(
      wrapper.find('SelectControl EmailLabel InlineSvg[src="icon-checkmark-sm"]').exists()
    ).toBe(true);

    // Send more reset the modal
    wrapper.find('Button[label="send more"]').simulate('click');
