...
class InviteMembersModal extends AsyncComponent<Props, State> {
  ...
  sendInvite = async (invite: NoramlizedInvite) => {
  ...
  get invites(): NoramlizedInvite[] {
    return this.state.pendingInvites.reduce<NoramlizedInvite[]>(
      (acc, row) => [
        ...acc,
            ...
            {complete ? (
              ...
              <React.Fragment>
                ...
                <Button
                  ...
                  label="send invites"
                  priority="primary"
                  disabled={!this.isValid || disableInputs}
